      ...
      >
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              <Truck className="w-5 h-5 text-[rgb(79,70,229)] mr-3" />
            ...
            <div className="relative prose dark:prose-invert max-w-none">
              <motion.div variants={itemVariants} className="space-y-8">
                <div className="space-y-6">
                  <h2 className="text-2xl font-bold bg-gradient-to-r from-[rgb(79,70,229)] to-purple-600 bg-clip-text text-transparent">1. Digital Delivery</h2>
                ...
                <div className="space-y-6">
                  <h2 className="text-2xl font-bold bg-gradient-to-r from-[rgb(79,70,229)] to-purple-600 bg-clip-text text-transparent">2. Access Methods</h2>
                  <p className="text-gray-600 dark:text-gray-300">
                    Our service can be accessed through:
                  </p>
                  <ul className="list-none space-y-2">
                    <motion.li 
                      variants={itemVariants}
                ...
                <div className="space-y-6">
                  <h2 className="text-2xl font-bold bg-gradient-to-r from-[rgb(79,70,229)] to-purple-600 bg-clip-text text-transparent">3. System Requirements</h2>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                <div className="space-y-6">
                  <h2 className="text-2xl font-bold bg-gradient-to-r from-[rgb(79,70,229)] to-purple-600 bg-clip-text text-transparent">4. Support</h2>
                  <p className="text-gray-600 dark:text-gray-300">
                    For access-related issues, contact us at:
                  </p>
                  <ul className="list-none space-y-2">
                    <motion.li 
                      variants={itemVariants}
