      ...
      >
        ...
        >
          <div className="max-w-4xl mx-8">
            <motion.h1
              variants={itemVariants}
              className="text-4xl font-bold mb-4 bg-gradient-to-r from-[rgb(79,70,229)] to-purple-600 bg-clip-text text-transparent leading-[1.2] md:leading-[1.2]"
            >
            ...
            >
              Track your progress, manage your questions, and get personalized
              learning insights
            </motion.p>
          </div>
        </motion.div>
