      ...
      >
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              <RefreshCcw className="w-5 h-5 text-[rgb(79,70,229)] mr-3" />
            ...
            <div className="relative prose dark:prose-invert max-w-none">
              <motion.div variants={itemVariants} className="space-y-8">
                <div className="space-y-6">
                  <h2 className="text-2xl font-bold bg-gradient-to-r from-[rgb(79,70,229)] to-purple-600 bg-clip-text text-transparent">1. No Refund Policy</h2>
                  <p className="text-gray-600 dark:text-gray-300">
                    As BrainlyAi is an online service providing instant access to AI-powered educational assistance, we do not offer refunds for purchased subscriptions. Once a subscription is activated, it will remain active until the end of the billing period.
                  </p>
                </div>

                <div className="space-y-6">
                  <h2 className="text-2xl font-bold bg-gradient-to-r from-[rgb(79,70,229)] to-purple-600 bg-clip-text text-transparent">2. Subscription Cancellation</h2>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                <div className="space-y-6">
                  <h2 className="text-2xl font-bold bg-gradient-to-r from-[rgb(79,70,229)] to-purple-600 bg-clip-text text-transparent">3. Contact Us</h2>
                  <p className="text-gray-600 dark:text-gray-300">
