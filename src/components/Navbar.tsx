...
export const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 w-full bg-white/80 dark:bg-gray-950/90 backdrop-blur-sm z-50 border-b border-transparent dark:border-gray-800">
        ...
        <div className="flex items-center space-x-6">
          ...
          {user ? (
            <div className="relative">
              ...
              {showDropdown && (
                <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-lg py-1 border border-gray-100 dark:border-gray-700">
