...
const CHROME_STORE_URL =
  'https://chrome.google.com/webstore/detail/brainlyai/ipkfbbjjlklmccnlhebanolgjhhjdidg';
  ...
  const mainFeatures = [
    {
      ...
      title: 'Snap & Solve',
      description:
        'Upload a photo of your question and get instant, accurate solutions powered by advanced AI technology',
    },
    {
      icon: <Brain className="w-6 h-6" />,
      title: 'AI-Powered Learning',
      description:
        'Our intelligent system adapts to your learning style, providing personalized explanations and guidance',
    },
    {
      icon: <MessageCircle className="w-6 h-6" />,
      title: 'Interactive Help',
      description:
        'Get step-by-step explanations with visual aids and engage in real-time problem-solving sessions',
    },
    {
      icon: <Sparkles className="w-6 h-6" />,
      title: 'Smart Solutions',
      description:
        'Experience precise answers and detailed explanations that help you truly understand the concepts',
    },
  ];
  ...
  const learningFeatures = [
    {
      ...
      description:
        'AI-driven system that adapts to your unique learning style and pace',
    },
    {
      icon: <Laptop className="w-6 h-6" />,
      title: 'Cross-Platform Access',
      description:
        'Seamlessly access your learning materials across all devices',
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: 'Verified Content',
      description:
        'All solutions are thoroughly verified for accuracy and clarity',
    },
  ];
                ...
                <div className="space-y-6">
                  {subjects.map((subject, index) => (
                    <div key={index} className="space-y-3">
                      <h4 className="text-lg font-semibold text-[rgb(79,70,229)]">
                        {subject.category}
                      </h4>
